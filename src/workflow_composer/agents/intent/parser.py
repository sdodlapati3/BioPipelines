...
class EntityPatterns:
    ...
    # Assay types
    ASSAY_TYPES = {
        "RNA-seq": ["rna-seq", "rnaseq", "rna seq", "mrna-seq", "transcriptome", "gene expression"],
        ...
        "WGBS": ["wgbs", "bisulfite", "methylation", "dna methylation", "450k", "epic", "methylome"],
        "Hi-C": ["hi-c", "hic", "3d genome", "chromatin conformation"],
        "DNase-seq": ["dnase-seq", "dnaseseq", "dnase"],
        "CUT&RUN": ["cut&run", "cutnrun", "cut and run"],
        "CUT&Tag": ["cut&tag", "cutntag", "cut and tag"],
        "WGS": ["wgs", "whole genome sequencing", "whole genome"],
        "WES": ["wes", "whole exome", "exome sequencing"],
